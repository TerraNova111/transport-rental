            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
                ...
                <div className="space-y-2">
                    <ul className="space-y-1">
                        ...
                        <li><Link to="/catalog" className="hover:text-gray-300">Автопарк</Link></li>
                ...
                <div className="space-y-2">
                    ...
                    <p className="flex items-center gap-2"><Phone className="w-5 h-5" /> +7 (777) 828-66-55</p>
                    <p className="flex items-center gap-2"><MapPin className="w-5 h-5" /> г.Алматы, Бостандыкский р-н, ул.Манаса, д.34/1</p>
                </div>
            </div>
